...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    ekspektasi: { jenis_transaksi: "paket_data", nominal: 11950, nama_produk: "AIGO 5.5 gb 3 hari", status: "sukses", perlu_review: true }
  },
  {
    ...
    ekspektasi: { jenis_transaksi: "paket_nelpon", nama_produk: "Talkmania Sakti Bulanan", nominal: 7999, status: "sukses" }
  },
  ...
  },
  {
    ...
    ekspektasi: { jenis_transaksi: "ewallet", nominal: 200000, nomor_tujuan: "081267746287", nama_produk: "DANA", nama_pemilik: "DNID-AVRXXXX WIJXXXXXX", status: "sukses" }
  },
  {
    nama: "E-wallet GoPay",
    provider: "alpines",
    ...
    ekspektasi: { jenis_transaksi: "ewallet", nominal: 100000, nomor_tujuan: "081372331339", nama_produk: "GoPay", nama_pemilik: "Jasmisaputra", status: "sukses" }
  },
  ...
  // ===== GAME TOP-UP =====
  {
    ...
    ekspektasi: { jenis_transaksi: "game_topup", nama_produk: "FREE FIRE", nominal: 14450, status: "sukses", perlu_review: true }
  },
...
function jalankanTest() {
  ...
  console.log(`Total kasus: ${testCases.length} (semua dari notifikasi nyata yang sudah dikonfirmasi)\n`);
  let jumlahPass = 0;
