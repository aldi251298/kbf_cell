...
exports.ATURAN_ADMIN_KONTER = void 0;
exports.terapkanAdminKonter = terapkanAdminKonter;
exports.ATURAN_ADMIN_KONTER = [
    {
 ...
 */
function terapkanAdminKonter(nominalDasar, jenisTransaksi, namaProduk) {
    if (nominalDasar == null) {
        return { nominalFinal: null, adminKonter: 0, adaAturan: false };
    }
    const kandidat = exports.ATURAN_ADMIN_KONTER.filter((a) => a.jenisTransaksi === jenisTransaksi);
